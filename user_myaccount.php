      ...
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item"><a class="nav-link active" href="user_myaccount.php"><span data-feather="calendar"></span><b>My account</b><span class="sr-only">(current)</span></a></li>
		...
		$email = htmlspecialchars($data['customer_email'],ENT_QUOTES);
			...
			echo '<div class="container">
			        ...
			        <h2 class="form-signin-heading">Your Details</h2><br>
			
			        <label>Name :	</label><pre>	  '.
			        $name.'</pre>

			        <br><label>Phone number :</label><pre>	  '.
			        $phone.'</pre>
			        
			        <label>Address:</label><pre>	  '.
			        $address.'</pre>

			        <label>State:</label><pre>	  '.
			        $state.'</pre>

			        <label>Email address:</label><pre>	  '.
			        $email.'</pre>      
			        <button class="btn btn-lg btn-primary btn-block" type="submit" name="submit">Change Details</button>
			      </form>
