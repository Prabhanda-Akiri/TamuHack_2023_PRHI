...
<html lang="en">
  <head>
    ...
    <title>Admin Home Page| View Products</title>
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="view_all.php">
                  <span data-feather="shopping-cart"></span>
                  View All Products
                </a>
              </li>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-sm">
              ...
              <tbody>
                <?php
                    $cek = mysqli_num_rows(mysqli_query($connect,"SELECT product_id,product_name,product_category,product_price,product_offer,product_description,product_status FROM product"));
                    $data = mysqli_query(
                    $connect,"SELECT product_id,product_name,product_category,product_price,product_offer,product_description,product_status FROM product");
                if ($cek>0)
                {     
                  while($row = mysqli_fetch_assoc($data))       
                    echo '<tr>
