...
<html lang="en">
  ...
  <style type="text/css">
    ...
    .sidenav:hover .feather,
.sidenav.active .feather {
  color: inherit;
}
  </style>
          ...
          <div class="col-md-8">
            <div class="tab-content profile-tab" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                  <?php
                    $name=$_SESSION['name'];
                    $cek = mysqli_num_rows(mysqli_query($connect,"SELECT admin_name,admin_state,admin_email FROM admin WHERE admin_name='$name'"));
                    $data = mysqli_fetch_array(mysqli_query(
                    $connect,"SELECT admin_name,admin_state,admin_email FROM admin WHERE admin_name='$name'"));
                    ...
                    if ($cek>0)
                      {
                          ...
                          echo  '<div class="row"><div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <p name="state">'.$data['admin_state'].'</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <p name="mail">'.$data['admin_email'].'</p>
                                </div>
                            </div>';
                          }
                      else
