              ...
              <?php
                ...
                if($chck>0)
                {
                  ...
                  while ($data=mysqli_fetch_array($result))
                  {
                    ...
                    echo '<td><a href="\Project\product_description.php?product_id='.$data['product_id'].'"><button type="button" class="btn btn-primary">View Product</button></a></td>';
                    //echo $looping;
                    echo '</tr>';
                    $looping++;
                  }
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              <?php
                ...
                $sql="select p.product_name,p.product_id,p.product_offer, p.product_price from product p inner join history h on p.product_id=h.product_id and p.product_status="accepted" order by h.no_of_views desc limit 10";
